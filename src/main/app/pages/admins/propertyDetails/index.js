        ...
        <div className="col-lg-4 col-md-12">
          ...
          <div className="card">
            ...
            <div
              ...
              type="button"
              role="button"
              onClick={() => _findAndRouteToAgent(property.agentID)}
            >
              View Agent
            </div>
            {property.isApproved ? (
              <div className="badge badge-info ml-3" role="status">
                Property Approved
              </div>
            ) : (
              <button
                className="btn btn-success btn-round ml-3 mt-3"
                type="button"
                onClick={() => _approve(property)}
                disabled={loading}
              >
